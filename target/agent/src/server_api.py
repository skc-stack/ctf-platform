...
class ServerAPI:
    ...
    def getflag(self, task_id: int, challenge_slug: str) -> ServerResponse:
        """GET /api/v1/device/task/{id}/flag — get flag for completed challenge."""
        return self._get(f"/api/v1/device/task/{task_id}/flag?challenge_slug={challenge_slug}")
