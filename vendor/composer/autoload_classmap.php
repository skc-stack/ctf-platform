...
return array(
    ...
    'CTF\\Server\\Controllers\\Admin\\DashboardController' => $baseDir . '/src/Controllers/Admin/DashboardController.php',
    'CTF\\Server\\Controllers\\Admin\\DeviceController' => $baseDir . '/src/Controllers/Admin/DeviceController.php',
    'CTF\\Server\\Controllers\\Admin\\UserApprovalController' => $baseDir . '/src/Controllers/Admin/UserApprovalController.php',
    'CTF\\Server\\Controllers\\AuthController' => $baseDir . '/src/Controllers/AuthController.php',
    'CTF\\Server\\Controllers\\BaseController' => $baseDir . '/src/Controllers/BaseController.php',
    'CTF\\Server\\Controllers\\CaptchaController' => $baseDir . '/src/Controllers/CaptchaController.php',
    'CTF\\Server\\Controllers\\DeviceApiController' => $baseDir . '/src/Controllers/DeviceApiController.php',
    'CTF\\Server\\Controllers\\DeviceController' => $baseDir . '/src/Controllers/DeviceController.php',
    'CTF\\Server\\Controllers\\HomeController' => $baseDir . '/src/Controllers/HomeController.php',
    'CTF\\Server\\Controllers\\Student\\ChallengeController' => $baseDir . '/src/Controllers/Student/ChallengeController.php',
    'CTF\\Server\\Controllers\\Student\\DashboardController' => $baseDir . '/src/Controllers/Student/DashboardController.php',
    'CTF\\Server\\Controllers\\Student\\DeviceController' => $baseDir . '/src/Controllers/Student/DeviceController.php',
    'CTF\\Server\\Controllers\\Student\\GroupController' => $baseDir . '/src/Controllers/Student/GroupController.php',
    'CTF\\Server\\Controllers\\SubmissionController' => $baseDir . '/src/Controllers/SubmissionController.php',
    'CTF\\Server\\Controllers\\TaskController' => $baseDir . '/src/Controllers/TaskController.php',
    'CTF\\Server\\Controllers\\Teacher\\ChallengeController' => $baseDir . '/src/Controllers/Teacher/ChallengeController.php',
    'CTF\\Server\\Controllers\\Teacher\\DashboardController' => $baseDir . '/src/Controllers/Teacher/DashboardController.php',
    'CTF\\Server\\Controllers\\Teacher\\GroupController' => $baseDir . '/src/Controllers/Teacher/GroupController.php',
    'CTF\\Server\\Database\\Connection' => $baseDir . '/src/Database/Connection.php',
    'CTF\\Server\\Http\\Request' => $baseDir . '/src/Http/Request.php',
    'CTF\\Server\\Http\\Response' => $baseDir . '/src/Http/Response.php',
    'CTF\\Server\\Http\\Router' => $baseDir . '/src/Http/Router.php',
    'CTF\\Server\\Http\\View' => $baseDir . '/src/Http/View.php',
    'CTF\\Server\\Middleware\\Auth' => $baseDir . '/src/Middleware/Auth.php',
    'CTF\\Server\\Middleware\\BaseMiddleware' => $baseDir . '/src/Middleware/BaseMiddleware.php',
    'CTF\\Server\\Middleware\\CSRF' => $baseDir . '/src/Middleware/CSRF.php',
    'CTF\\Server\\Middleware\\DeviceAuth' => $baseDir . '/src/Middleware/DeviceAuth.php',
    'CTF\\Server\\Middleware\\Guest' => $baseDir . '/src/Middleware/Guest.php',
    'CTF\\Server\\Middleware\\RateLimit' => $baseDir . '/src/Middleware/RateLimit.php',
    'CTF\\Server\\Middleware\\RateLimitFlagSubmit' => $baseDir . '/src/Middleware/RateLimitFlagSubmit.php',
    'CTF\\Server\\Middleware\\RateLimitLogin' => $baseDir . '/src/Middleware/RateLimitLogin.php',
    'CTF\\Server\\Middleware\\RateLimitPasswordReset' => $baseDir . '/src/Middleware/RateLimitPasswordReset.php',
    'CTF\\Server\\Middleware\\RateLimitTaskValidate' => $baseDir . '/src/Middleware/RateLimitTaskValidate.php',
    'CTF\\Server\\Middleware\\RequireAdmin' => $baseDir . '/src/Middleware/RequireAdmin.php',
    'CTF\\Server\\Middleware\\RequireRole' => $baseDir . '/src/Middleware/RequireRole.php',
    'CTF\\Server\\Middleware\\RequireStudent' => $baseDir . '/src/Middleware/RequireStudent.php',
    'CTF\\Server\\Middleware\\RequireTeacher' => $baseDir . '/src/Middleware/RequireTeacher.php',
    'CTF\\Server\\Models\\Group' => $baseDir . '/src/Models/Group.php',
    'CTF\\Server\\Repositories\\ChallengePackageRepository' => $baseDir . '/src/Repositories/ChallengePackageRepository.php',
    'CTF\\Server\\Repositories\\ChallengeRepository' => $baseDir . '/src/Repositories/ChallengeRepository.php',
    'CTF\\Server\\Repositories\\DeviceRepository' => $baseDir . '/src/Repositories/DeviceRepository.php',
    'CTF\\Server\\Repositories\\GroupMemberRepository' => $baseDir . '/src/Repositories/GroupMemberRepository.php',
    'CTF\\Server\\Repositories\\GroupRepository' => $baseDir . '/src/Repositories/GroupRepository.php',
    'CTF\\Server\\Repositories\\NonceRepository' => $baseDir . '/src/Repositories/NonceRepository.php',
    'CTF\\Server\\Repositories\\SolveRepository' => $baseDir . '/src/Repositories/SolveRepository.php',
    'CTF\\Server\\Repositories\\SubmissionRepository' => $baseDir . '/src/Repositories/SubmissionRepository.php',
    'CTF\\Server\\Repositories\\TaskSessionRepository' => $baseDir . '/src/Repositories/TaskSessionRepository.php',
    'CTF\\Server\\Repositories\\UserRepository' => $baseDir . '/src/Repositories/UserRepository.php',
    'CTF\\Server\\Security\\CSRF' => $baseDir . '/src/Security/CSRF.php',
    'CTF\\Server\\Security\\ConstantTimeCompare' => $baseDir . '/src/Security/ConstantTimeCompare.php',
    'CTF\\Server\\Security\\FlagGenerator' => $baseDir . '/src/Security/FlagGenerator.php',
    'CTF\\Server\\Security\\PasswordHasher' => $baseDir . '/src/Security/PasswordHasher.php',
    'CTF\\Server\\Security\\ZipValidator' => $baseDir . '/src/Security/ZipValidator.php',
    'CTF\\Server\\Services\\ActivationCodeService' => $baseDir . '/src/Services/ActivationCodeService.php',
    'CTF\\Server\\Services\\AuditLog' => $baseDir . '/src/Services/AuditLog.php',
    'CTF\\Server\\Services\\AuthService' => $baseDir . '/src/Services/AuthService.php',
    'CTF\\Server\\Services\\CaptchaService' => $baseDir . '/src/Services/CaptchaService.php',
    'CTF\\Server\\Services\\ChallengeManifestParser' => $baseDir . '/src/Services/ChallengeManifestParser.php',
    'CTF\\Server\\Services\\ChallengeService' => $baseDir . '/src/Services/ChallengeService.php',
    'CTF\\Server\\Services\\DeviceService' => $baseDir . '/src/Services/DeviceService.php',
    'CTF\\Server\\Services\\GroupService' => $baseDir . '/src/Services/GroupService.php',
    'CTF\\Server\\Services\\Mailer' => $baseDir . '/src/Services/Mailer.php',
    'CTF\\Server\\Services\\NylasClient' => $baseDir . '/src/Services/NylasClient.php',
    'CTF\\Server\\Services\\PasswordResetService' => $baseDir . '/src/Services/PasswordResetService.php',
    'CTF\\Server\\Services\\SubmissionService' => $baseDir . '/src/Services/SubmissionService.php',
    'CTF\\Server\\Services\\TaskService' => $baseDir . '/src/Services/TaskService.php',
    'CTF\\Server\\Services\\TaskValidationException' => $baseDir . '/src/Services/TaskValidationException.php',
    'CTF\\Server\\Services\\VerificationService' => $baseDir . '/src/Services/VerificationService.php',
    'CTF\\Server\\Support\\Config' => $baseDir . '/src/Support/Config.php',
    'CTF\\Server\\Support\\Logger' => $baseDir . '/src/Support/Logger.php',
