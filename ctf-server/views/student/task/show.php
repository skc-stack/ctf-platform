...
<section class="ctf-dash">
    ...
    .task-progress-steps .step.active.blink { animation: blink-animation 1s ease-in-out infinite }
    .task-progress-steps .step.active.blink span { color:#ffe066;text-shadow:0 0 8px #ffe066,0 0 12px #ffaa00 }
